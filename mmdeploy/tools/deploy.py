...
def parse_args():
    ...
    parser.add_argument('--calib-dataset-cfg',
                        ...
                        default=None)
    parser.add_argument('--device', help='device used for conversion', default='cuda:0')
    parser.add_argument(
        '--log-level',
        help='set log level', default='INFO', choices=list(logging._nameToLevel.keys()))
    parser.add_argument('--show', action='store_true', help='Show detection outputs')
    parser.add_argument('--dump-info', default=False, action='store_true', help='Output information for SDK, does not work for Voxel based models for now')
    parser.add_argument(
        '--quant-image-dir', default=None,
    ...
    parser.add_argument('--visualize-model', default=False, action='store_true', help='Model visulaization, does not work for nuScenes model')
...
def main():
    ...
    # Below visualization code  work for nuscenes if the range_min is 4000 in config
